...
(defpackage mathseml
	...
	(:shadow *)	(:export *)
	(:shadow /)	(:export /)
	(:shadow summation)	(:export summation)
	(:shadow product)	(:export product)
	(:export plus)
	(:export minus)
	(:export mult)
	(:export fract)
...
(defpackage sodf
	...
	(:export font-face-decls)
	(:shadow list) (:export list)
	(:export list-item)
	(:export scripts)
	(:export presentation)
	(:export object)
...
(defpackage effable-odt
	(:use cl)
	(:use utils)
	(:use semantrix)
	(:use seml)
	(:use sodf)
	(:shadowing-import-from sodf list)
	(:import-from semantrix person)
	(:import-from semantrix make-person)
	(:import-from semantrix person-additional-name)
	(:import-from semantrix person-address)
	...
	(:import-from semantrix dc-email)
	(:import-from semantrix dc-phone)
	(:shadowing-import-from mathseml math)
	(:shadowing-import-from mathseml =)
	(:shadowing-import-from mathseml +)
	(:shadowing-import-from mathseml -)
	(:shadowing-import-from mathseml *)
